...
namespace AuctionWeb.Migrations
{
    ...
    [Migration("20250407104540_Update_Shipment2")]
    partial class Update_Shipment2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AuctionWeb.Models.Shipment", b =>
                {
                    ...
                    b.Property<int>("Shipment_Auction_ID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Shipment_Auction_ID");
            ...
            modelBuilder.Entity("AuctionWeb.Models.Shipment", b =>
                {
                    b.HasOne("AuctionWeb.Models.Auction", "Auction")
                        .WithMany()
                        .HasForeignKey("Shipment_Auction_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
