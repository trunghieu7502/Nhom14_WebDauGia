...
namespace AuctionWeb.Migrations
{
    ...
    [Migration("20250406154547_AddMinBidIncrement")]
    partial class AddMinBidIncrement
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AuctionWeb.Models.Product", b =>
                {
                    ...
                    b.Property<int>("ProductCategoryProduct_Cate_ID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ProductCategoryProduct_Cate_ID");
            ...
            modelBuilder.Entity("AuctionWeb.Models.Product", b =>
                {
                    b.HasOne("AuctionWeb.Models.ProductCategory", "ProductCategory")
                        .WithMany()
                        .HasForeignKey("ProductCategoryProduct_Cate_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
